...
# default, matching Codex's own current default (config.toml model = "gpt-5.6-sol"). 5.5 stays
# reachable via its explicit alias for fallback.
provider_codex_resolve() {
    ...
    case "$alias" in
        ...
        5.5)                        P_MODEL="gpt-5.5" ;;
        5.5-high)                   P_MODEL="gpt-5.5"; P_EFFORT="high" ;;
